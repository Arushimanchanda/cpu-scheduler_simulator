# gantt.py
# Handles all visualization - Gantt chart and performance metrics
...
def draw_gantt(timeline, results, algo_name):
    ...
    # Create two subplots - one for Gantt chart, one for metrics
    ...
    # Draw waiting time vs turnaround time bar chart
